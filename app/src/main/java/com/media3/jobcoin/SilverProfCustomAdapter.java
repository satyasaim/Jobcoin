...
class SilverProfCustomAdapter extends RecyclerView.Adapter<SilverProfCustomAdapter.MyViewHolder>{
    ...
    public SilverProfCustomAdapter(Context context, ArrayList<String> jseekernames, ArrayList<String> experience,
    ...
    @Override
    public SilverProfCustomAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_find_resumes_item, viewGroup, false);
        SilverProfCustomAdapter.MyViewHolder mvh = new SilverProfCustomAdapter.MyViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final SilverProfCustomAdapter.MyViewHolder holder, final int i) {
    ...
    public int getItemCount() {
      new PrefManager(view.getContext()).saveTotalSilverProfiles(String.valueOf(jseekernames.size()));
