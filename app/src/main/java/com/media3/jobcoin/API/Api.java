...
//                    .cache(cache).addInterceptor(logging).build();
            ...
            if (retrofit==null) {
                ...
                retrofit=new Retrofit.Builder().baseUrl("https://jobcoin.co.in/").addConverterFactory(ScalarsConverterFactory.create()).addConverterFactory(GsonConverterFactory.create()).client(okHttpClient).build();
