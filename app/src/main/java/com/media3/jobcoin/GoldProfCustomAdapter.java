...
class GoldProfCustomAdapter  extends RecyclerView.Adapter<GoldProfCustomAdapter.MyViewHolder> {
    ...
    public  GoldProfCustomAdapter(Context context, ArrayList<String> jseekernames,ArrayList<String> experience,
    ...
    @Override
    public GoldProfCustomAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_find_resumes_item, viewGroup, false);
        GoldProfCustomAdapter.MyViewHolder mvh = new GoldProfCustomAdapter.MyViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final GoldProfCustomAdapter.MyViewHolder holder, final int i) {
